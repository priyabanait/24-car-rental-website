...
export const metadata = {
  title: 'Privacy Policy - 24-Car Rental',
  description: 'Learn how 24-Car Rental collects, uses, and protects your information.',
}
        ...
        <div className="max-w-4xl mx-auto bg-white rounded-lg shadow-lg p-8">
          ...
          <section className="mb-6">
            ...
            <p className="text-gray-600 leading-relaxed">
              At <span className="font-semibold">24-Car Rental</span>, we respect your privacy and are committed to protecting your personal information. This policy explains what information we collect, how we use it, and the choices you have.
            </p>
          </section>
          ...
          <section className="mb-6">
            ...
            <p className="text-gray-600 leading-relaxed">
              Depending on where you live, you may have rights to access, correct, or delete your personal data. To exercise these rights, contact us at <a href="mailto:support@carrental.com" className="text-green-600">support@carrental.com</a>.
            </p>
          </section>
          ...
          <section className="mb-6">
            ...
            <p className="text-gray-600 leading-relaxed">
              If you have any questions about this policy, please email <a href="mailto:support@carrental.com" className="text-green-600">support@carrental.com</a> or call +91 70883 46129.
            </p>
          </section>

          <footer className="mt-8 border-t pt-6 text-sm text-gray-500">
            <p>Thank you for choosing <span className="font-semibold">24-Car Rental</span>.</p>
          </footer>
        </div>
      </div>
    </main>
